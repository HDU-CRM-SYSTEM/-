          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="float: right;">
                <a href="AddWorkLog.php"><button type="button" class="btn btn-info">新建日志</button></a>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody id="list">
                  <tr>
                    <td></td>
                    <td>2017.12.29 工作日志</td>
                    <td>日报</td>
                    <td>admin</td>
                    <td>2017.12.29</td>
                    <td>
                      <div class="btn-group">
                        <a href="ShowWorkLog.php"><button type="button" class="btn btn-default btn-xs">查看</button></a>
                        <a href="EditWorkLog.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
