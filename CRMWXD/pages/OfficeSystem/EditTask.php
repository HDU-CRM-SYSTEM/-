    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              <li class="active"><a href="../../pages/OfficeSystem/Task.php"><i class="fa fa-tasks"></i> 任务</a></li>
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="主题" class="control-label col-md-1" style="width: 20%">主题</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="制定本月销售计划">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="负责人" class="control-label col-md-1" style="width: 20%">负责人</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="admin,lck">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="任务相关人" class="control-label col-md-1" style="width: 20%">任务相关人</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="admin,lck">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="选择相关" class="control-label col-md-1" style="width: 20%">选择相关</label>
                    <div>
                      <select class="form-control select2 col-md-1" style="width: 100px">
                        <option>产品</option>
                        <option>客户</option>
                        <option>合同</option>
                      </select>
                      <input type="text" class="control-label col-md-4" style="width: 300px">
                    </div>  
                  </div>
                </div> 
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="优先级" class="control-label col-md-1" style="width: 20%">优先级</label>
                    <div>
                  ...
                  <div class="form-group">
                    <label for="截止时间" class="control-label col-md-1" style="width: 20%">截止时间</label>
                    <div>
                      <input type="date" class="control-label" style="width: 40%" value="<%=date()%>">
                    </div>                  
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="描述" class="col-md-1 control-label">描述</label>
                    <div class="col-md-11">
                      <textarea id="editor1" name="editor1" rows="10" cols="80">
                                            2018年1月5日之前必须完成所有采购计划的制定
                      </textarea>
                    </div>
                  </div> 
                </div>
              ...
              <div class="btn-group col-md-12" style="text-align:center;">
                <a href="Task.php"><button type="button" class="btn btn-success" id="check">确认</button></a>
                <a href="Task.php"><button type="button" class="btn btn-success" id="back">返回</button></a>
              </div>
            </div>
          </form>
      </div>
