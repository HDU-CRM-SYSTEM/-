            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="float: right;">
                <button type="button" class="btn btn-info">新建</button>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="AddExamination.php">新建请假单</a></li>
                    <li><a href="#">新建报销单</a></li>
                    <li><a href="#">新建差旅单</a></li>
                    <li><a href="#">新建借款单</a></li>
                  </ul>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                <thead>
                  ...
                  <th style="width:7%">审批单类型</th>
                  <th style="width:7%">审批类型</th>
                  <th style="width:6%">审批内容</th>
                  <th style="width:7%">审批意见</th>
                  <th style="width:9%">下一审批人</th>
                ...
                <tbody id="list">
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="ShowExamination.php"><button type="button" class="btn btn-default btn-xs">查看</button></a>
                        <a href="EditExamination.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
