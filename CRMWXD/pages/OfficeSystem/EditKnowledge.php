          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="鑫达小组名单">
                    </div>                  
                  </div>
                </div>
                <div class="col-md-12">
              ...
              <div class="btn-group col-md-12" style="text-align:center;">
                <a href="Knowledge.php"><button type="button" class="btn btn-success" id="check">确认</button></a>
                <a href="Knowledge.php"><button type="button" class="btn btn-success" id="back">返回</button></a>
              </div>
            </div>
          </form>
      </div>
