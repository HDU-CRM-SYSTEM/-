      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/OfficeSystem/WorkLog.php"><i class="fa fa-magic"></i> 工作日志</a></li>
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="日志类型" class="control-label col-md-1" style="width: 20%">日志类型</label>
                    <div>
                      <input type="radio" class="control-label" name="CmpNature">沟通日志
                      <input type="radio" class="control-label" name="CmpNature" checked="checked">日报
                      <input type="radio" class="control-label" name="CmpNature">周报
                      <input type="radio" class="control-label" name="CmpNature">月报
                    </div>                  
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="标题" class="control-label col-md-1" style="width: 20%">标题</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="2017.12.29 工作日志">
                    </div>                  
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="内容" class="col-md-1 control-label">内容</label>
                    <div class="col-md-11">
              ...
              <div class="btn-group col-md-12" style="text-align:center;">
                <a href="WorkLog.php"><button type="button" class="btn btn-success" id="check">确认</button></a>
                <a href="WorkLog.php"><button type="button" class="btn btn-success" id="back">返回</button></a>
              </div>
            </div>
          </form>
      </div>
