      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/OfficeSystem/Schedule.php"><i class="fa fa-calendar"></i> 日程</a></li>
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="面见客户">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="开始时间" class="control-label col-md-1" style="width: 20%">开始时间</label>
                    <div>
                      <input type="date" class="control-label" style="width: 40%">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="地点" class="control-label col-md-1" style="width: 20%">地点</label>
                    <div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="admin">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="结束时间" class="control-label col-md-1" style="width: 20%">结束时间</label>
                    <div>
                      <input type="date" class="control-label" style="width: 40%">
                    </div>                  
                  </div>
              ...
              <div class="btn-group col-md-12" style="text-align:center;">
                <a href="Schedule.php"><button type="button" class="btn btn-success" id="check">确认</button></a>
                <a href="Schedule.php"><button type="button" class="btn btn-success" id="back">返回</button></a>
              </div>
            </div>
          </form>
      </div>
