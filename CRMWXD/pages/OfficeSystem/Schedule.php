          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="float: right;">
                <a href="AddSchedule.php"><button type="button" class="btn btn-info">新建日程</button></a>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                <thead>
                  ...
                  <th style="width:7%">起始时间日期</th>
                  <th style="width:7%"">截止日期时间</th>
                  <th style="width:8%">日程地点</th>
                ...
                <tbody id="list">
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="ShowSchedule.php"><button type="button" class="btn btn-default btn-xs">查看</button></a>
                        <a href="EditSchedule.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
