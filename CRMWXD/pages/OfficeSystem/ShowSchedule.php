          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="left: 45%">
                <a href="EditSchedule.php"><button type="button" class="btn btn-info">修改</button></a>
                <a href="#"><button type="button" class="btn btn-info">删除</button></a>
                <a href="Schedule.php"><button type="button" class="btn btn-info">返回</button></a>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
