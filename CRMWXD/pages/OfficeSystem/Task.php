          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="float: right;">
                <a href="AddTask.php"><button type="button" class="btn btn-info">新建任务</button></a>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody id="list">
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="ShowTask.php"><button type="button" class="btn btn-default btn-xs">查看</button></a>
                        <a href="EditTask.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
