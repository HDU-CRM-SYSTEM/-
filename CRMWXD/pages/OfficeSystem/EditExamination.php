      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/OfficeSystem/Examination.php"><i class="fa fa-times-circle-o"></i> 审批</a></li>
          </ul>
        </li>
      </ul>
    </section>
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="申请人" class="control-label col-md-1" style="width: 20%">申请人</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="lck">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="请假事项" class="control-label col-md-1" style="width: 20%">请假事项</label>
                    <div>
                  ...
                  <div class="form-group">
                    <label for="审批人" class="control-label col-md-1" style="width: 20%">审批人</label>
                    <div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="描述" class="col-md-1 control-label">请假内容</label>
                    <div class="col-md-11">
              ...
              <div class="btn-group col-md-12" style="text-align:center;">
                <a href="Examination.php"><button type="button" class="btn btn-success" id="check">确认</button></a>
                <a href="Examination.php"><button type="button" class="btn btn-success" id="back">返回</button></a>
              </div>
            </div>
          </form>
      </div>
