...
<head>
  ...
  <title>EditWorkAcceptance</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/OfficeSystem/WorkAcceptance.php"><i class="fa fa-bars"></i> 工单受理</a></li>
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="订单" class="control-label col-md-1" style="width: 20%">订单</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="WXD201712290001">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="选择相关" class="control-label col-md-1" style="width: 20%">优先级</label>
                    <div>
                      <select class="form-control select2 col-md-1" style="width: 40%">
                        <option>高</option>
                        <option>中</option>
                        <option>低</option>
                      </select>
                  ...
                  <div class="form-group">
                    <label for="交易金额" class="control-label col-md-1" style="width: 20%">交易金额</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="1000.0">
                    </div>                  
                  </div>
                  <div class="form-group">
                    <label for="期望结果" class="control-label col-md-1" style="width: 20%">期望结果</label>
                    <div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="杭州电子科技大学">
                    </div>  
                  </div>
                  <div class="form-group">
                    <label for="到期时间" class="control-label col-md-1" style="width: 20%">到期时间</label>
                    <div>
                      <input type="date" class="control-label" style="width: 40%">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="预留电话" class="control-label col-md-1" style="width: 20%">预留电话</label>
                    <div>
                      <input type="text" class="control-label" style="width: 40%" placeholder="15968810636">
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="描述" class="col-md-1 control-label">工单描述</label>
                    <div class="col-md-11">
              ...
              <div class="btn-group col-md-12" style="text-align:center;">
                <a href="WorkAcceptance.php"><button type="button" class="btn btn-success" id="check">确认</button></a>
                <a href="WorkAcceptance.php"><button type="button" class="btn btn-success" id="back">返回</button></a>
              </div>
            </div>
          </form>
      </div>
