...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <script>
        function doDel(id){
            if(confirm("确定要删除吗？")){
                window.location="action_activity.php?action=del&id="+id;
            }
        }
    </script>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width: 10%">
                      <a href="AddMarketActivity.php.php"><button type="button" class="btn btn-default">新建 活动</button></a>
                  </th>
                </tr>
                </thead>
                <tbody>
...
<!--                  </tr>-->
                    <?php
                        ...
                        $sql="select * from market_activity";
                        ...
                        while($row=mysqli_fetch_assoc($res)){
                            ...
                            echo "<td>
                                    <div class=\"btn-group\">
                                        <button type=\"button\" class=\"btn btn-default\"><a href='EditMarketActivity.php?id={$row["id"]}'>修改</a></button>
