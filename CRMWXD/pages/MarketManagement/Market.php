                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 10%">
                                        <a href="AddMarket.php"><button type="button" class="btn btn-default">新建 市场</button></a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                $sql="select * from market_management";
                                ...
                                while($row=mysqli_fetch_assoc($res)){
                                    ...
                                    echo "<td>
								<div class=\"btn-group\">
                                    <button type=\"button\" class=\"btn btn-default\"><a href='EditMarket.php?id={$row["id"]}'>修改</a></button>
