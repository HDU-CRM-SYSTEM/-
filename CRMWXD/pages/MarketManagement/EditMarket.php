<?php
    ...
    $id=$_GET["id"];
    $sql="select * from market_management where id={$id}";
              ...
              <span class="label label-primary pull-right"></span>
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="../../pages/MarketManagement/Market.php"><i class="fa fa-table"></i> 市场管理</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">修改市场信息</h3>
                        </div>
                        <div class="box-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">市场名称</label>
                                    <div class="col-sm-11">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">市场信息</label>
                                    <div class="col-sm-11">
