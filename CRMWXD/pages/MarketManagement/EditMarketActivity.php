<?php
    ...
    $id=$_GET["id"];
    $sql="select * from market_activity where id={$id}";
...
require("layout.php");
?>
<title>EditMarketActivity</title>
              ...
              <span class="label label-primary pull-right"></span>
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="../../pages/MarketManagement/MarketActivity.php"><i class="fa fa-table"></i> 市场活动</a></li>
                        ...
                        <div class="box-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="hidden" id="hidden" value="<?php echo $row['id'];?>">
                                        <input type="text" id="name" class="form-control" value="<?php echo $row["name"];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">活动信息</label>
                                    <div class="col-sm-11">
                                        <textarea id="editor1" name="editor1" rows="6" cols="155" style="width: 100%; height: 120px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row["message"];?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">活动地址</label>
                                    <div class="col-sm-11">
...
<script>
    ...
    $(document).ready(function(){
        $("#submit").on("click",function(){
            ...
            $.ajax({
                type:"POST",
                url:"action_activity.php?action=update",
                data:{
                    id:id,
                    name:name,
                    message:message,
                ...
                success:function(data){
                    ...
                    if(data.code==0){
                        setTimeout(function(){
                            window.location="MarketActivity.php";
                        },1000)
                    }
                }
            })
