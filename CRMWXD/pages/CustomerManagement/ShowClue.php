        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">线索详情</h3>
              <div class="btn-group" style="left: 70%">
                <a href="EditClue.php?id=<?php echo $id?>"><button type="button" class="btn btn-info">修改</button></a>
                <a href="dealClue.php?action=del&id=<?php echo $id?>"><button type="button" class="btn btn-info">删除</button></a>
                <a href="#"><button type="button" class="btn btn-info">转换</button></a>
                <a href="Clue.php"><button type="button" class="btn btn-info">返回</button></a>
              </div>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                        ...
                        echo "<td>地址</td>";
                        echo "<td>".$row['province']."-".$row['city']."-".$row['area']."-".$row['street']."</td>";
                        echo "</tr><tr>";
                        echo "<td>下次联系时间</td>";
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools" style="left: 85%">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  <th style="width: 15%">沟通时间</th>
                  <th style="width: 15%">沟通内容</th>
              ...
              <div class="col-xs-12">
                <div class="col-xs-3">
                  <label for="沟通时间">沟通时间</label>
                  <input type="date">
                </div>
                <div class="col-xs-3">
                  <label for="沟通内容">沟通内容</label>
                  <input type="text">
                </div>
                <div class="col-xs-2">
                  <label for="沟通结果">沟通结果</label>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <div class="col-xs-12">
                <div class="col-xs-3">
                  <label for="任务目标">任务目标</label>
                  <input type="date">
                </div>
                <div class="col-xs-3">
                  <label for="完成时间">完成时间</label>
                  <input type="">
                </div>
                <div class="col-xs-2">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <div class="col-xs-12">
                <div class="col-xs-3">
                  <label for="文件名">文件</label>
                  <input type="file">
                </div>
                <div class="col-xs-3">
                  <label for="上传时间">沟通内容</label>
                  <input type="date">
                </div>
                <div class="col-xs-5">
                  <label for="备注"> 备注</label>
