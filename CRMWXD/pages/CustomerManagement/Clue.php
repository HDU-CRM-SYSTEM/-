            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    $sql="select * from clue where flag=1";
                    ...
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        echo "<td>
                                <div class='btn-group'>
                                    ...
                                    <a href=\"EditClue.php?id={$row['id']}\"><button type=\"button\" class=\"btn btn-default btn-xs\">修改</button></a>
                                    <a href=\"AddCustomer.php\"><button type=\"button\" class=\"btn btn-default btn-xs\">转换</button></a>
                                </div>
							  </td>";
                        echo "</tr>";
                    }
