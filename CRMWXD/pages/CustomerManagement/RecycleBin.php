  ...
  <aside class="main-sidebar">
    <!-- sidebar: style can be found in sidebar.less -->
      <script>
          function doDel(id){
              if(confirm("确定要删除吗？")){
                  window.location="dealClue.php?action=thdel&id="+id;
              }
          }
      </script>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <div style="width:100%; height:1px; border-top:1px solid #999; clear:both;"></div>
              <li class="active"><a href="../../pages/CustomerManagement/RecycleBin.php"><i class="fa fa-recycle"></i> 回收站</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-striped">
                <thead>
                  ...
                  <th style="width:8%">删除时间</th>
                  <th style="width:10%">操作</th>
                </thead>
                <tbody id="list">
                <?php
                require("../../dbconfig.php");
                $sql="select * from clue where flag=2";
                ...
                while($row=mysqli_fetch_assoc($res)){
                    ...
                    echo "<td>
                            <div class=\"btn-group\">
                                ...
                                <a href=\"dealClue.php?action=recovery&id={$row['id']}\"><button type=\"button\" class=\"btn btn-default btn-xs\">回收</button></a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a href="#"><button type="button" class="btn btn-default btn-xs">回收</button></a>
