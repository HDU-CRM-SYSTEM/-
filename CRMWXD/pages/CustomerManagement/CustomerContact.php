          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="float: right;">
                <a href="AddCustomerContact.php"><button type="button" class="btn btn-info">新建联系人</button></a>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody id="list">
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="EditCustomerContact.php"><button type="button" class="btn btn-default btn-xs">编辑</button></a>
