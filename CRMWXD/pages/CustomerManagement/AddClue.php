  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-info">
        ...
        <form class="form-horizontal" method="post" action="dealClue.php?action=add">
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div>
                    <input type="text" class="control-label" name="chargeName" style="width: 40%">
                ...
                <div class="form-group">
                  ...
                  <div>
                    <input type="text" class="control-label" name="post" style="width: 40%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="手机" class="control-label col-md-1" style="width: 20%">手机</label>
                  <div>
                    <input type="text" class="control-label" name="telephone" style="width: 40%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="下次联系时间" class="control-label col-md-1" style="width: 20%">下次联系时间</label>
                  <div>
                    <input type="date" class="control-label" name="nexttime" style="width: 40%">
                  </div>                  
                </div>
              </div> 
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div>
                    <input type="text" class="control-label" name="company" style="width: 60%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="联系人姓名" class="control-label col-md-1" style="width: 20%">联系人姓名</label>
                  <div>
                    <input type="text" class="control-label" name="contact" required="required" style="width: 60%">
                ...
                <div class="form-group">
                  ...
                  <div>
                    <select name="sex" class="form-control select2" style="width: 60%;">
                      <option>先生</option>
                      <option>女士</option>
                    </select>
                  </div>                  
                ...
                <div class="form-group">
                  ...
                  <div>
                    <input type="email" name="email" class="control-label" style="width: 60%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="下次联系内容" class="control-label col-md-1" style="width: 20%">下次联系内容</label>
                  <div>
                    <input type="text" class="control-label" name="nextcontent" style="width: 60%">
                  </div>                  
                </div>
              </div>   
              <div class="col-md-12">  
                ...
                <div col-md-11>
                    <input type="text" class="control-label" name="province" style="width: 15%" placeholder="省">
                    <input type="text" class="control-label" name="city" style="width: 15%" placeholder="市">
                    <input type="text" class="control-label" name="area" style="width: 15%" placeholder="区">
                    <input type="text" class="control-label" name="street" style="width: 10%" placeholder="街道信息">
                  </div>
              </div> 
              <div class="col-md-12">
                <h4>附加信息</h4>
