        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">报价单信息</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="btn-group" style="float: right;">
                <a href="AddQuotation.php"><button type="button" class="btn btn-info">添加</button></a>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                <thead>
                  <th style="width:10%">编号</th>
                  <th style="width:10%">商机名</th>
                  <th style="width:8%"">状态</th>
                  <th style="width:8%">报价</th>
                  <th style="width:8%">报价阶段</th>
                  <th style="width:8%">距到期</th>
                  <th style="width:8%">总数量</th>
                  <th style="width:6%">报价时间</th>
                ...
                <tbody id="list">
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="ShowClue.php"><button type="button" class="btn btn-default btn-xs">审核</button></a>
                        <a href="EditClue.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
                        <a><button type="button" class="btn btn-default btn-xs">转换</button></a>
                      </div>
                    </td>
                  </tr>
                </tbody>            
