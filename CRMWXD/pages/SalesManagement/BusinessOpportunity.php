...
<head>
  ...
  <title>BusinessOpporrtunity</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group">
                  <button type="button" class="btn btn-info">导出商机</button>
              </div>
              <div class="btn-group" style="float: right;">
                <a href="AddBusinessOpportunity.php"><button type="button" class="btn btn-info">添加商机</button></a>
              </div>
              <p></p>
                ...
                <tbody id="list">
                  <tr>
                    <td></td>
                      ...
                      <td>
                      <div class="btn-group">
                        <a href="ShowBusinessOpportunity.php"><button type="button" class="btn btn-default btn-xs">查看</button></a>
                        <a href="EditBusinessOpportunity.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
                        <a><button type="button" class="btn btn-default btn-xs">推进</button></a>
                      </div>
                    </td>
                  </tr>
                </tbody>            
