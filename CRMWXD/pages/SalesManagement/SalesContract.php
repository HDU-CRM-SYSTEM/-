      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/SalesManagement/SalesContract.php"><i class="fa fa-file-text-o"></i> 销售合同</a></li>
            </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="btn-group" style="float: right;">
                <a href="AddSalesContract.php"><button type="button" class="btn btn-info">添加合同</button></a>
              </div>
              <p></p>
              <table id="example2" class="table table-bordered table-striped">
                <thead>
                  ...
                  <th style="width:10%">客户/供应商</th>
                  <th style="width:8%"">联系人</th>
                  <th style="width:8%">负责人</th>
                  <th style="width:8%">签约日期</th>
                ...
                <tbody id="list">
                  <tr>
                    <td></td>
                      ...
                      <td>
                      <div class="btn-group">
                        <a href="ShowSalesContract.php"><button type="button" class="btn btn-default btn-xs">查看</button></a>
                        <a href="EditSalesContract.php"><button type="button" class="btn btn-default btn-xs">修改</button></a>
                      </div>
                    </td>
                  </tr>
                </tbody>            
