      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/SalesManagement/Quotation.php"><i class="fa  fa-pencil-square-o"></i> 报价单</a></li>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="商机名称" class="control-label col-md-1" style="width: 20% ">商机名称</label>
                  <div>
                    <input type="text" class="control-label" style="width: 40%">
                  </div>                  
                </div>               
                ...
                <div class="form-group">
                  <label for="联系方式" class="control-label col-md-1" style="width: 20%">联系方式</label>
                  <div>
                    <input type="text" class="control-label" style="width: 40%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="报价时间" class="control-label col-md-1" style="width: 20%">报价时间</label>
                  <div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="报价主题" class="control-label col-md-1" style="width: 20%">报价主题</label>
                  <div>
                    <input type="text" class="control-label" style="width: 60%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="报价阶段" class="control-label col-md-1" style="width: 20%">报价阶段</label>
                  <div>
                ...
                <div class="form-group">
                  <label for="制单人" class="control-label col-md-1" style="width: 20%">制单人</label>
                  <!-- 当前用户 -->
                  <div>
                    <input type="text" disabled="disabled" class="control-label" style="width: 60%">
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="有效期至" class="control-label col-md-1" style="width: 20%">有效期至</label>
                  <div>
                    <input type="date" class="control-label" style="width: 60%">
                  </div>                  
                </div>
              </div>    
              <div class="col-md-12">
                <div class="form-group">
                  <label for="备注" class="col-md-1 control-label">产品详情</label>
                  <div class="col-md-11">
                    <div class="box">
                      <div>
